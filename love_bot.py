...
async def send_daily_reminder(context: ContextTypes.DEFAULT_TYPE):
    """Ежедневное напоминание в 00:00 по Москве"""
...
def main():
    ...
    try:
        ...
        # Настраиваем ежедневное уведомление с помощью JobQueue
        job_queue = application.job_queue
        
        # Создаем время для уведомления (00:00 по Москве = 21:00 UTC предыдущего дня)
        target_time = datetime.strptime("21:00", "%H:%M").time()  # 21:00 UTC = 00:00 MSK
        ...
        # Добавляем ежедневную job для проверки праздников (тоже в 00:00 по Москве)
        job_queue.run_daily(
        ...
        print("📅 Ежедневные уведомления настроены на 00:00 по Москве")
        print("🎉 Праздничные уведомления включены")
